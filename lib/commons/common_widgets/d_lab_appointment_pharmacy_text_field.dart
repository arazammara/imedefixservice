...
class DLabAppointmentPharmactTextField extends StatelessWidget {
  ...
  const DLabAppointmentPharmactTextField(
      {Key? key,
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              contentPadding: trailingIconPath != null
                  ? EdgeInsets.only(top: 15, left: 15.w)
              ...
              hintStyle: getSemiBoldStyle(
                  fontSize: MyFonts.size14,
                  color: hintColor ?? MyColors.accountTypeTextColor),
...
class DOfferInfoTextFieldMaxLine extends StatelessWidget {
  final TextEditingController controller;
  final String hintText;
  final Color? hintColor;
  final Function(String) onChanged;
  ...
  const DOfferInfoTextFieldMaxLine({
    Key? key,
    required this.controller,
    required this.hintText,
    required this.onChanged,
