...
class DoctorCheckOutPharmacy extends StatefulWidget {
  const DoctorCheckOutPharmacy({super.key});

  @override
  State<DoctorCheckOutPharmacy> createState() => _DoctorCheckOutPharmacyState();
}

class _DoctorCheckOutPharmacyState extends State<DoctorCheckOutPharmacy> {
