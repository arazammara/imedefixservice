...
class DoctorCheckOutLabTest extends StatefulWidget {
  const DoctorCheckOutLabTest({super.key});

  @override
  State<DoctorCheckOutLabTest> createState() => _DoctorCheckOutLabTestState();
}

class _DoctorCheckOutLabTestState extends State<DoctorCheckOutLabTest> {
