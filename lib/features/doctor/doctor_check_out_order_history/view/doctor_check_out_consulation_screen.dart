...
class DoctorCheckOutConsulation extends StatefulWidget {
  const DoctorCheckOutConsulation({super.key});

  @override
  State<DoctorCheckOutConsulation> createState() =>
      _DoctorCheckOutConsulationState();
}

class _DoctorCheckOutConsulationState extends State<DoctorCheckOutConsulation> {
