...
class DAppointmentOfferInfoSection extends StatelessWidget {
  GlobalKey<FormState> formKey;
   
  DAppointmentOfferInfoSection({super.key, required this.formKey});
        ...
        child: Column(
          ...
          children: [
            ...
            DOfferInfoTextField(
              validatorFn: (value) {
                if (value!.isEmpty) {
                  return 'Please enter your Appointment Address';
                }
                return null;
              },
              texfieldHeight: 54.h,
