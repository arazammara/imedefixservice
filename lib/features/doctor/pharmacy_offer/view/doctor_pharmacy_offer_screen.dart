...
import 'package:idaawee/features/doctor/pharmacy_offer/widgets/d_pharmacy_offer_info_section.dart';
import 'package:idaawee/features/doctor/pharmacy_offer/widgets/d_pharmacy_popular_item_section.dart';
import 'package:idaawee/routes/route_manager.dart';
import 'package:idaawee/utils/constants/font_manager.dart';

import '../../../../commons/common_widgets/d_common_appbar.dart';

class DoctorPharmacyOfferScreen extends StatelessWidget {
  DoctorPharmacyOfferScreen({super.key});
          ...
          child: Column(
              ...
              children: [
                ...
                const DCategorySection(
                  categories: [menCare, skinCare, antiAlergic, vitamins],
                ),
                padding15,
                DPharmactOfferInfoSection(
                  formKey: _formKey,
                ),
                padding15,
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        Navigator.pushNamed(
                            ...
                            arguments: {
                              'msg': yourProducthasbeenavailableforpurchase
                            });
                      }
                    },
