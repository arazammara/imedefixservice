...
import 'package:idaawee/features/doctor/consulation_offer/widgets/d_offer_info_section.dart';
...
class DoctorConsulationOfferScreen extends StatelessWidget {
  DoctorConsulationOfferScreen({super.key});
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      Navigator.pushNamed(
                          ...
                          arguments: {
                            'msg':
                                yourconsultationofferhasbeensuccessfullyposted
                          });
                    }
                  },
