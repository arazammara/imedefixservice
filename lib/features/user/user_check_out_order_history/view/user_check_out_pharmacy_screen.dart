...
class UserCheckOutPharmacy extends StatefulWidget {
  const UserCheckOutPharmacy({super.key});

  @override
  State<UserCheckOutPharmacy> createState() => _UserCheckOutPharmacyState();
}

class _UserCheckOutPharmacyState extends State<UserCheckOutPharmacy> {
