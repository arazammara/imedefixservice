...
class UserCheckOutAppointmentScreen extends StatefulWidget {
  const UserCheckOutAppointmentScreen({super.key});

  @override
  State<UserCheckOutAppointmentScreen> createState() =>
      _UserCheckOutAppointmentScreenState();
}

class _UserCheckOutAppointmentScreenState
    extends State<UserCheckOutAppointmentScreen> {
