...
class CheckOutConsulation extends StatefulWidget {
  const CheckOutConsulation({super.key});

  @override
  State<CheckOutConsulation> createState() => _CheckOutConsulationState();
}

class _CheckOutConsulationState extends State<CheckOutConsulation> {
